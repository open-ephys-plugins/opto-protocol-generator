# Opto Protocol Generator

A sink that generates a protocol for optogenetic stimulation experiments.
...
Next, launch Visual Studio and open the `OE_PLUGIN_opto-protocol-generator.sln` file that was just created. Select the appropriate configuration (Debug/Release) and build the solution.
...
Next, launch Xcode and open the `opto-protocol-generator.xcodeproj` file that now lives in the “Build” directory.
...
This plugin has been developed by Josh Siegle at the Allen Institute for Neural Dynamics.
